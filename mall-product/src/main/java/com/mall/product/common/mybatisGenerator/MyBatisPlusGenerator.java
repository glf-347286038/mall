package com.mall.product.common.mybatisGenerator;
...
public class MyBatisPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        globalConfig.setAuthor("gaolingfeng");
        globalConfig.setOpen(false);
        autoGenerator.setGlobalConfig(globalConfig);

        // 数据源配置 需配置====================================>
        DataSourceConfig dataSourceConfig = new DataSourceConfig();
        dataSourceConfig.setUrl("jdbc:mysql://47.98.149.207:3306/mall-user?useUnicode=true&characterEncoding=utf-8&useSSL=false&serverTimezone=UTC");
        // dataSourceConfig.setSchemaName("public");
        dataSourceConfig.setDriverName("com.mysql.cj.jdbc.Driver");
        dataSourceConfig.setUsername("root");
        dataSourceConfig.setPassword("158d3e483dc2");
...
//        packageConfig.setModuleName("mall-user");
        packageConfig.setParent("com.mall.user.common");
